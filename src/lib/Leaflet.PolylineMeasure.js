...
(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        options: {
             ...
             * @default
             */
            tooltipTextFinish: 'Hattı bitirmek için <b> Tıklayınız</b><br>',
            tooltipTextDelete: 'Noktayı silmek için <b> Shift basılı tutup tıklayınız.</b>',
            tooltipTextMove: 'Taşımak için <b> Tıklayıp Taşıyınız.</b><br>',
            tooltipTextResume: '<br>Hatta devam etmek için <b> CTRL basılı tutup tıklayınız.</b>',
            tooltipTextAdd: 'Nokta eklemek için <b> CTRL Basılı tutup tıklayınız.</b>',
             ...
             * @default
             */
            measureControlTitleOn: "Ölçmeyi Aç",
            /**
             * Title for the control going to be switched off
             * @type {String}
             * @default
             */
            measureControlTitleOff: "Ölçmeyi Kapat",
            /**
